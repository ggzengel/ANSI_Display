...
void LCD_1IN47_SetWindows(UWORD Xstart, UWORD Ystart, UWORD Xend, UWORD Yend)
{
	...
	{ 
		...
		LCD_1IN47_SendData_8Bit((Xstart + 0x22) >> 8);
		LCD_1IN47_SendData_8Bit(Xstart + 0x22);
		LCD_1IN47_SendData_8Bit((Xend + 0x22) >> 8);
		LCD_1IN47_SendData_8Bit(Xend + 0x22);

		// set the Y coordinates
		LCD_1IN47_SendCommand(0x2B);
		LCD_1IN47_SendData_8Bit(Ystart >> 8);
		LCD_1IN47_SendData_8Bit(Ystart);
		LCD_1IN47_SendData_8Bit(Yend >> 8);
		LCD_1IN47_SendData_8Bit(Yend);
	}
	else
	{ 
		// set the X coordinates
		...
		LCD_1IN47_SendData_8Bit(Xend >> 8);
		LCD_1IN47_SendData_8Bit(Xend);

		// set the Y coordinates
		LCD_1IN47_SendCommand(0x2B);
		LCD_1IN47_SendData_8Bit((Ystart + 0x22) >> 8);
		LCD_1IN47_SendData_8Bit(Ystart + 0x22);
		LCD_1IN47_SendData_8Bit((Yend + 0x22) >> 8);
		LCD_1IN47_SendData_8Bit(Yend + 0x22);
	}
...
void LCD_1IN47_Clear(UWORD Color)
{
    ...
    LCD_1IN47_SetWindows(0, 0, LCD_1IN47.WIDTH - 1, LCD_1IN47.HEIGHT - 1);
    DEV_Digital_Write(LCD_DC_PIN, 1);
    DEV_Digital_Write(LCD_CS_PIN, 0);
